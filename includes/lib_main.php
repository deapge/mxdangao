...
function assign_template($ctype = '', $catlist = array())
{
    ...
    //print_r(cat_list(0, 0, false, 1, false));exit();
...
function get_navigator($ctype = '', $catlist = array())
{
    ...
    {
        //print_r($navlist['middle']);exit();
        //print_r(get_child_tree($v['cid']));exit();
        $navlist['middle'][$k]['cat_id'] = get_child_tree($v['cid']);
        $navlist['middle'][$k]['ad_id'] = isset($ads_arr[$v['cid']])?$ads_arr[$v['cid']]:'';
