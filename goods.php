...
if (!empty($_REQUEST['act']) && $_REQUEST['act'] == 'price')
{
    ...
    else
    {
        ...
        $goods_model  = goods_info($goods_id);
        $res['market_price'] = price_format($goods_model['market_price'] + $shop_price * $number - $goods_model['shop_price']);//市场价格
    }
...
// 广告
$smarty->assign('detail_adv',     getads(171,1));
