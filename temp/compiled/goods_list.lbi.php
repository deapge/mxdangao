...
?>
    <?php if ($this->_var['goods']['goods_id']): ?>
     <div class="goodsItem" style="padding: 10px 3px 15px 2px;" >
         ...
         <div class="jiage">
             <font class="f1"><?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></font><br />
         </div>
         <div class="jiage0">
