...
<div class="block clearfix" style="margin-bottom: 10px;">
    <a href="<?php echo $this->_var['detail_adv']['0']['ad_link']; ?>"><img src="<?php echo $this->_var['detail_adv']['0']['ad_code']; ?>" alt="<?php echo $this->_var['detail_adv']['0']['title']; ?>"/></a>
</div>
  ...
  <div class="AreaR" style="float: left;">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <a href="<?php echo $this->_var['pictures']['0']['img_url']; ?>" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo $this->_var['goods']['goods_style_name']; ?>">
      <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="466px"/>
     </a>
    ...
    <div style="text-align:center; position:relative; width:100%;">
     ...
     <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="clearfix h1">
          <div class="t fl"><?php echo $this->_var['goods']['goods_style_name']; ?></div>
          <?php if ($this->_var['cfg']['show_goodssn']): ?>
            <div class="t1 fr" style="margin-right: 100px;"> <strong><?php echo $this->_var['lang']['goods_sn']; ?></strong><?php echo $this->_var['goods']['goods_sn']; ?></div>
          <?php endif; ?>
      </div>
...
?>
	  ...
	  <ul class="ul2 clearfix roles-price-ul">
	     <li style=" width:100%;height:30px; line-height:50px;" class="clearfix">
             价格: <font class="shop" id="ECS_MARKETPRICE1" style="font-size:18px; color:#CE1919; font-weight:700;"><?php echo $this->_var['goods']['market_price']; ?></font>
             <?php echo $this->_var['lang']['shop_price']; ?><font class="shop" id="ECS_SHOPPRICE" style="font-size:18px; color:#CE1919; font-weight:700;"><?php echo $this->_var['goods']['shop_price_formated']; ?></font>
         ...
         <li style=" float:left; width:515px; height:30px; line-height:30px; display: none;">
                <div class="market">市场价格：<em id="marketPrice"><?php echo $this->_var['goods']['market_price']; ?></em></div>
         	  </li>
	  </ul>
      ...
      <strong><?php echo $this->_var['lang']['add_time']; ?></strong><?php echo $this->_var['goods']['add_time']; ?>
       ...
       <li class="clearfix hidden"><dd><strong><?php echo $this->_var['lang']['goods_click_count']; ?>：</strong><?php echo $this->_var['goods']['click_count']; ?></dd></li>
...
?>
      <li class="clearfix" style="<?php if ($this->_var['goods']['goods_type'] == '2'): ?>width:100%;<?php endif; ?>">
         <dd>
         
         <strong>[<?php echo htmlspecialchars($this->_var['property']['name']); ?>]：</strong><?php echo $this->_var['property']['value']; ?>
         </dd>
        </li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
      <li class="padd loop">
      <strong><?php echo $this->_var['spec']['name']; ?>：
          <?php if ($this->_var['spec']['name'] == '蛋糕尺寸'): ?>请选择尺寸：<?php endif; ?>
          <?php if ($this->_var['spec']['name'] == '餐具份数'): ?>请选择餐具：<?php endif; ?>
      </strong>
...
?>
      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       ...
       <strong><?php echo $this->_var['lang']['number']; ?>：</strong>
        <a href="javascript:void(0)" onclick="goods_num_change('-','<?php echo $this->_var['goods']['goods_id']; ?>')">[-]</a>&nbsp;<input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" style="border:1px solid #ccc; "/>&nbsp;<a href="javascript:void(0)" onclick="goods_num_change('+','<?php echo $this->_var['goods']['goods_id']; ?>')">[+]</a>
           <strong><?php echo $this->_var['lang']['amount']; ?>：</strong><font id="ECS_GOODS_AMOUNT" class="f1"></font>
       </dd>
       </li>
      
      <li class="padd">
      <a class="addToCart1" href="javascript:addToCart1(<?php echo $this->_var['goods']['goods_id']; ?>)">立即购买</a>
      <a class="addToCart" href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)">加入购物车</a>
         ...
         <div class="new_right_QQ" style="border-bottom: 1px dotted #E20909;color:red;font-size: 16px;">
             <table width="500">
                 <tbody><tr>
                     ...
                     <td><a href="javascript:;"><?php echo $this->_var['service_phone']; ?></a></td>
                     <td><img src="themes/ecmoban_meilishuo/images/pro_qq.png"></td>
                     <td><a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=<?php echo $this->_var['qq']['0']; ?>&amp;Site=<?php echo $this->_var['shop_name']; ?>&amp;Menu=yes" title="点击咨询QQ客服" target="_blank"><?php echo $this->_var['qq']['0']; ?></a></td>
     ...
     <div class="box">
      ...
      <div id="com_h">
       <blockquote>
           ...
           <?php if ($this->_var['goods']['goods_type'] == '1'): ?>
           <div style="text-align: center"><img src="themes/ecmoban_meilishuo/images/dangao.jpg" alt=""/></div>
           <?php else: ?>
           <div style="text-align: center"><img src="themes/ecmoban_meilishuo/images/xianhua.jpg" alt=""/></div>
           <?php endif; ?>
       </blockquote>
